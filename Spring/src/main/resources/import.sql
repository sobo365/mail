...
insert into accounts(account_id, displayname, in_server_address, in_server_port, in_server_type, password, smtpaddress, smtp_port, username, user_user_id) values (1, 'a', null, 0, 0, 'a','a', 8080, 'a', 1)
insert into accounts(account_id, displayname, in_server_address, in_server_port, in_server_type, password, smtpaddress, smtp_port, username, user_user_id) values (2, 'b', null, 0, 0, 'b','b', 443, 'b', 1)
