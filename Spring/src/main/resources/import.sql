...
insert into messages(message_id, bcc, cc, content, date_time, _from, subject, _to, _unread, account_message_account_id, in_folder_folder_id, _received) values(2, null, null, 'content2', '2019-08-11 2:00:00', 'bfrom2', 'subject2' ,'to2', true, 1,1, true)
